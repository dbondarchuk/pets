...
import { allergySearhParamsLoader } from '@/lib/searchparams';
...
export const GET = async (
  ...
  const searchParams = allergySearhParamsLoader(request.nextUrl.searchParams);
  ...
  const allergies = await petsRepository.getPetAllergies({
    page,
    limit,
    query,
    petId,
...
export const POST = async (
  ...
  await petsRepository.createPetAllergy(pet.id, parseResult.data);
