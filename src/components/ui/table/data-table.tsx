...
export function DataTable<TData, TValue>({
  ...
  const translatedColumns: ColumnDef<TData>[] = useMemo(
    () =>
      columns.map((col) => ({
        ...col,
      ...
      <div className='flex flex-col items-center justify-end gap-2 space-x-2 py-2 sm:flex-row'>
        <div className='flex w-full items-center justify-between'>
          <div className='flex-1 text-sm text-muted-foreground'>
            {totalItems > 0
              ? t('showing_items_of_total_label', {
                  start:
              ...
              : t('no_entries_found_label')}
          </div>
          <div className='flex flex-col items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8'>
            <div className='flex items-center space-x-2'>
              <p className='whitespace-nowrap text-sm font-medium'>
                {t('rows_per_page_label')}
              </p>
              <Select
        ...
        <div className='flex w-full items-center justify-between gap-2 sm:justify-end'>
          ...
          <div className='flex items-center space-x-2'>
            <Button
              aria-label={t('go_to_first_page_label')}
              variant='outline'
            ...
            <Button
              aria-label={t('go_to_previous_page_label')}
              variant='outline'
            ...
            <Button
              aria-label={t('go_to_next_page_label')}
              variant='outline'
              className='h-8 w-8 p-0'
            ...
            <Button
              aria-label={t('go_to_last_page_label')}
              variant='outline'
              className='hidden h-8 w-8 p-0 lg:flex'
